...
GLfloat r = 0.64705, g = 0.21568, b = 0.99215;
GLint light = 1;
int count = 1, flg = 1;
int view = 1;
...
GLvoid DrawGLScene()
{
  ...
  else
  {
    ...
    glPointSize(30.0);
    glBegin(GL_POINTS);
    glVertex3f(0.55, 0.3, 0.33);
    glVertex3f(0.55, 0.3, 0.73);
    glColor3f(1.0, .75, 0.0);
    glVertex3f(2.2, 0.3, 0.33);
    glVertex3f(2.2, 0.3, 0.73);
    glEnd();
    glPointSize(200.0);
    ...
    glColor3f(0, 0, 0);
    glBegin(GL_QUADS);
    glVertex3f(2.2, 0.3, 0.58);
    glVertex3f(2.2, 0.3, 0.42);
    glVertex3f(2.2, 0.25, 0.42);
    glVertex3f(2.2, 0.25, 0.58);
    glVertex3f(0.55, 0.3, 0.6);
    glVertex3f(0.55, 0.3, 0.44);
    glVertex3f(0.55, 0.25, 0.44);
    glVertex3f(0.55, 0.25, 0.6);
    glEnd();
    ...
    glVertex3f( 0.55, 0.4, 0.2);
//****************************************************************************
    glVertex3f(0.7, 0.65, 0.8);
    glVertex3f(0.7, 0.65, 0.2);
    glVertex3f(1.7, 0.65, 0.2);      //top cover
    glVertex3f(1.7, 0.65, 0.8);
//***************************back guard******************************
...
//*********************DOOR HANDLE********************************** 
    ...
    // FRONT RIGHT
    glVertex3f(1.25, 0.4, 0.82);
    glVertex3f(1.25, 0.42, 0.82);
    glVertex3f(1.35, 0.42, 0.82);
    glVertex3f(1.35, 0.4, 0.82);

    glVertex3f(1.25, 0.4, 0.8);
    glVertex3f(1.25, 0.42, 0.8);
    glVertex3f(1.35, 0.42, 0.8);
    glVertex3f(1.35, 0.4, 0.8);
    ...
    // BACK RIGHT
    glVertex3f(0.8, 0.4, 0.82);
    glVertex3f(0.8, 0.42, 0.82);
    glVertex3f(0.9, 0.42, 0.82);
    glVertex3f(0.9, 0.4, 0.82);

    glVertex3f(0.8, 0.4, 0.8);
    glVertex3f(0.8, 0.42, 0.8);
    glVertex3f(0.9, 0.42, 0.8);
    glVertex3f(0.9, 0.4, 0.8);
    ...
    // FRONT LEFT
    glVertex3f(1.25, 0.4, 0.18);
    glVertex3f(1.25, 0.42, 0.18);
    glVertex3f(1.35, 0.42, 0.18);
    glVertex3f(1.35, 0.4, 0.18);

    glVertex3f(1.25, 0.4, 0.2);
    glVertex3f(1.25, 0.42, 0.2);
    glVertex3f(1.35, 0.42, 0.2);
    glVertex3f(1.35, 0.4, 0.2);
    ...
    // BACK LEFT
    glVertex3f(0.8, 0.4, 0.18);
    glVertex3f(0.8, 0.42, 0.18);
    glVertex3f(0.9, 0.42, 0.18);
    glVertex3f(0.9, 0.4, 0.18);

    glVertex3f(0.8, 0.4, 0.2);
    glVertex3f(0.8, 0.42, 0.2);
    glVertex3f(0.9, 0.42, 0.2);
...
//*********************ENTER WINDOW**********************************
    glColor3f(34 / 255, 167 / 255, 240 / 255);
    ...
    glVertex3f( 0.75, 0.65, 0.8);
    glVertex3f(0.75, 0.63, 0.8);       //line strip
    glVertex3f(1.7, 0.63, 0.8);
    glVertex3f( 1.7, 0.65, 0.8);

    glColor3f(34 / 255, 167 / 255, 240 / 255);
    glVertex3f( 0.77, 0.63, 0.8);
    glVertex3f(0.75, 0.5, 0.8);       //quad front window
    glVertex3f(1.2, 0.5, 0.8);
    glVertex3f( 1.22, 0.63, 0.8);

    glVertex3f(1.27, 0.63, 0.8);
    glVertex3f(1.25, 0.5, 0.8);      //quad back window
    glVertex3f(1.65, 0.5, 0.8);
    glVertex3f(1.67, 0.63, 0.8);

    glColor3f(r, g, b);
    glVertex3f(0.7, 0.65, 0.8);
    glVertex3f(0.7, 0.5, 0.8);     //first separation
    glVertex3f(0.75, 0.5, 0.8);
    glVertex3f(0.77, 0.65, 0.8);

    glVertex3f(1.2, 0.65, 0.8);
    glVertex3f(1.2, 0.5, 0.8);     //second separation
    glVertex3f(1.25, 0.5, 0.8);
    glVertex3f(1.27, 0.65, 0.8);

    glVertex3f(1.65, 0.65, 0.8);
    glVertex3f(1.65, 0.5, 0.8);
...
//*************************************************************************************************
    ...
    glColor3f(34 / 255, 167 / 255, 240 / 255);
    glVertex3f( 0.6, 0.5, 0.8);
    glVertex3f( 0.7, 0.65, 0.8);     //tri front window
...
//************IGNITION SYSTEM**********************************
    ...
    gluCylinder(t, 0.015, 0.015, .5, 10, 10);
    glPopMatrix();
//********************WHEEL*********************************************
    ...
    {
      for (int i = 0; i < 25; i++) {
        glVertex3f(0.8, 0.2, 0.82);
        glVertex3f(0.8 + (0.08 * (cos(((theta + angle + i) * 3.14) / 180))), 0.2 + (0.08 * (sin(((theta + angle + i) * 3.14) / 180))), 0.82);
      }
    }
    glEnd();
    ...
    {
      for (int i = 0; i < 25; i++) {
        glVertex3f(0.8, 0.2, 0.18);
        glVertex3f(0.8 + (0.08 * (cos(((theta + angle + i) * 3.14) / 180))),
                   0.2 + (0.08 * (sin(((theta + angle + i) * 3.14) / 180))), 0.18);
      }
    }
    glEnd();
    ...
    for (theta = 0; theta < 360; theta = theta + 60)
    {
      for (int i = 0; i < 25; i++) {
        ...
        glVertex3f(1.7 + (0.08 * (cos(((theta + angle + i) * 3.14) / 180))),
                   0.2 + (0.08 * (sin(((theta + angle + i) * 3.14) / 180))), 0.18);
      }
    }
    glEnd();
    ...
    {
      for (int i = 0; i < 25; i++) {
        glVertex3f(1.7, 0.2, 0.82);
        glVertex3f(1.7 + (0.08 * (cos(((theta + angle + i) * 3.14) / 180))), 0.2 + (0.08 * (sin(((theta + angle + i) * 3.14) / 180))), 0.82);
      }
    }
    glEnd();
    glTranslatef(0.8, 0.2, 0.8);
    glColor3f(0, 0, 0);
    glutSolidTorus(0.035, 0.1, 10, 25);
